...
- [x] E2E tests for entity lifecycle ✅ (10 tests in src/cli/commands/entity.test.ts covering registration, update, deactivation, reactivation, persistence, tags, uniqueness, special characters)
