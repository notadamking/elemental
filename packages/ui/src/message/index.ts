 ...
 *
 * Shared message UI components for Elemental platform.
 *
 * Usage:
 * - Import components: import { MessageRichComposer, CreateChannelModal } from '@elemental/ui/message'
 * - Also available via main entry: import { MessageRichComposer } from '@elemental/ui'
 */
