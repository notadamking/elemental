...
describe('RoleDefinitionService', () => {
  ...
  describe('getRoleDefinition', () => {
    ...
    test('returns undefined for non-existent ID', async () => {
      const retrieved = await service.getRoleDefinition('el-nonexistent' as unknown as import('@elemental/core').ElementId);
  ...
  describe('getSystemPrompt', () => {
    ...
    test('returns undefined for non-existent definition', async () => {
      const prompt = await service.getSystemPrompt('el-nonexistent' as unknown as import('@elemental/core').ElementId);
  ...
  describe('updateRoleDefinition', () => {
    ...
    test('throws error for non-existent definition', async () => {
      await expect(
        service.updateRoleDefinition('el-nonexistent' as unknown as import('@elemental/core').ElementId, { name: 'New' })
  ...
  describe('deleteRoleDefinition', () => {
    ...
    test('returns false for non-existent definition', async () => {
      const deleted = await service.deleteRoleDefinition('el-nonexistent' as unknown as import('@elemental/core').ElementId);
