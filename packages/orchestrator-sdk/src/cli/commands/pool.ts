...
async function poolShowHandler(
  ...
  if (!idOrName) {
    return failure('Usage: el pool show <id|name>\nExample: el pool show default', ExitCode.INVALID_ARGUMENTS);
  }
...
async function poolCreateHandler(
  ...
  if (!name) {
    return failure('Usage: el pool create <name> [options]\nExample: el pool create default --size 5', ExitCode.INVALID_ARGUMENTS);
  }
...
export const poolCreateCommand: Command = {
  ...
  usage: 'el pool create <name> [options]',
...
async function poolUpdateHandler(
  ...
  if (!idOrName) {
    return failure('Usage: el pool update <id|name> [options]\nExample: el pool update default --size 10', ExitCode.INVALID_ARGUMENTS);
  }
...
export const poolUpdateCommand: Command = {
  ...
  usage: 'el pool update <id|name> [options]',
...
async function poolDeleteHandler(
  ...
  if (!idOrName) {
    return failure('Usage: el pool delete <id|name>\nExample: el pool delete old-pool', ExitCode.INVALID_ARGUMENTS);
  }
...
async function poolStatusHandler(
  ...
  if (!idOrName) {
    return failure('Usage: el pool status <id|name>\nExample: el pool status default', ExitCode.INVALID_ARGUMENTS);
  }
...
export const poolCommand: Command = {
  ...
  usage: 'el pool <subcommand> [options]',
