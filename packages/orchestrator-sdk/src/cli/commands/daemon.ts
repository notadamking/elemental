...
Examples:
  el daemon start
  el daemon start --server http://localhost:8080`,
...
Examples:
  el daemon stop
  el daemon stop --force
  el daemon stop --server http://localhost:8080`,
...
export const daemonStatusCommand: Command = {
  ...
  usage: 'el daemon status [options]',
...
Examples:
  ...
  el daemon status --server http://localhost:8080`,
  options: daemonOptions,
...
export const daemonCommand: Command = {
  ...
  usage: 'el daemon <subcommand> [options]',
