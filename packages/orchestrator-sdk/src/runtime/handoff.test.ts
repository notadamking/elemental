 ...
 * and ElementalAPI to test handoff logic without actual processes or database.
 */

import { describe, test, expect, beforeEach } from 'bun:test';
import { EventEmitter } from 'node:events';
import type { EntityId, ChannelId, DocumentId, Document, Message } from '@elemental/core';
import { createTimestamp, ElementType, ContentType } from '@elemental/core';
