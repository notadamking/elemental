...
import type { Element, Dependency } from '@elemental/core';
import { ValidationError, ErrorCode, isElement, validateElement, isDependency, validateDependency } from '@elemental/core';
