...
import { ValidationError } from '@elemental/core';
...
describe('Validation', () => {
  ...
  describe('validateDatabase', () => {
    test('returns valid database name', () => {
      expect(validateDatabase('elemental.db')).toBe('elemental.db');
    });

    test('throws on missing .db extension', () => {
      expect(() => validateDatabase('elemental')).toThrow(ValidationError);
    });
...
describe('Defaults', () => {
  describe('DEFAULT_CONFIG', () => {
    test('has all required fields', () => {
      expect(DEFAULT_CONFIG.database).toBe('elemental.db');
...
describe('Merge', () => {
  ...
  describe('createConfiguration', () => {
    ...
    test('merges partial into defaults', () => {
      ...
      expect(result.database).toBe('elemental.db');
    });
  });
...
describe('Path Expansion', () => {
  describe('expandPath', () => {
    test('expands ~ to home directory', () => {
      ...
      expect(expandPath('~/.elemental')).toBe(path.join(home, '.elemental'));
    });
...
describe('Configuration API', () => {
  ...
  describe('loadConfig', () => {
    test('returns default config when no files/env', () => {
      ...
      expect(config.database).toBe('elemental.db');
    });
  ...
  describe('getValue', () => {
    ...
    test('gets top-level values', () => {
      ...
      expect(getValue('database')).toBe('elemental.db');
    });
