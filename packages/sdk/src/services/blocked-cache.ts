...
import type { ElementId, EntityId, DependencyType, AwaitsMetadata } from '@elemental/core';
import { DependencyType as DT, GateType, isValidAwaitsMetadata } from '@elemental/core';
