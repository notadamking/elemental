 ...
 * @elemental/sdk
 *
 * Core SDK for Elemental - API, services, sync, and CLI.
 * This package provides the main programmatic interface to Elemental,
 * building on @elemental/core for types and @elemental/storage for persistence.
 *
 * Note: Types from @elemental/core and @elemental/storage are NOT re-exported here
 * to avoid naming conflicts. Import them directly:
 *   import { Task, Entity, ... } from '@elemental/core';
 *   import { createStorage, ... } from '@elemental/storage';
 */
