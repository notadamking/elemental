 ...
 * 1. Known packages: Auto-detect first-party packages (e.g., @elemental/orchestrator-sdk)
 * 2. Config-based: User-specified packages in .elemental/config.yaml plugins.packages
 */
 ...
 */
const KNOWN_PLUGIN_PACKAGES = ['@elemental/orchestrator-sdk'] as const;
