...
import { createStorage, initializeSchema, CURRENT_SCHEMA_VERSION } from '@elemental/storage';
...
describe('doctor command', () => {
  test('reports error when no workspace exists', async () => {
    ...
    // Change cwd temporarily by using a nonexistent .elemental
    rmSync(ELEMENTAL_DIR, { recursive: true });
