...
import type { Element, ElementId, EntityId, Timestamp, Dependency } from '@elemental/core';
import { ElementType, createTimestamp, DependencyType, ErrorCode } from '@elemental/core';
...
function createTempDir(): string {
  return mkdtempSync(join(tmpdir(), 'elemental-http-sync-test-'));
}
