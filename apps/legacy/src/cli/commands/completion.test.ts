...
describe('completion command', () => {
  ...
  test('generates bash completion', async () => {
    ...
    expect(result.exitCode).toBe(ExitCode.SUCCESS);
    expect(result.message).toContain('_elemental_completion');
    expect(result.message).toContain('complete -F _elemental_completion el');
  });
  ...
  test('generates zsh completion', async () => {
    ...
    expect(result.exitCode).toBe(ExitCode.SUCCESS);
    expect(result.message).toContain('#compdef el elemental');
    expect(result.message).toContain('_el()');
  });
  ...
  test('generates fish completion', async () => {
    ...
    expect(result.exitCode).toBe(ExitCode.SUCCESS);
    expect(result.message).toContain('complete -c el');
    expect(result.message).toContain('complete -c elemental');
  });
...
describe('completion script content', () => {
  test('bash script contains essential elements', async () => {
    ...
    expect(result.message).toContain('complete -F _elemental_completion');
  });
  ...
  test('zsh script contains essential elements', async () => {
    ...
    expect(result.message).toContain('_el()');
    expect(result.message).toContain('_el_commands');
