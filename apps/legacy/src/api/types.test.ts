...
import { ElementType, type Element, type ElementId, type EntityId, type Timestamp } from '../types/element.js';
import { TaskStatus, Priority, Complexity, TaskTypeValue, type Task } from '../types/task.js';
...
// ============================================================================
// ElementalAPI Interface Tests
// ============================================================================

describe('ElementalAPI Interface', () => {
  it('should define all required CRUD methods', () => {
    // Create a mock that satisfies the ElementalAPI interface
