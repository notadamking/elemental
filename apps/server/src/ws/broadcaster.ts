...
export class EventBroadcaster {
  private api: ElementalAPI;
  private listeners: Set<EventListener> = new Set();
  private lastEventId: number = 0;
  private pollInterval: ReturnType<typeof setInterval> | null = null;
  private pollIntervalMs: number;

  constructor(api: ElementalAPI, pollIntervalMs: number = 500) {
    this.api = api;
 ...
 */
export function initializeBroadcaster(api: ElementalAPI, pollIntervalMs?: number): EventBroadcaster {
  if (!broadcaster) {
