# Elemental Design Tokens

This directory contains the design token system for the Elemental web platform. Design tokens are the single source of truth for visual styling and ensure consistency across the application.
