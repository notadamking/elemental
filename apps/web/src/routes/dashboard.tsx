  ...
  return (
    <div className="mt-8" data-testid="recent-activity">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link to="/dashboard/timeline" search={{ page: 1, limit: 100, actor: undefined, startTime: undefined, endTime: undefined }} className="text-sm text-blue-600 hover:text-blue-700 flex items-center gap-1">
          View all <ArrowRight className="w-4 h-4" />
        </Link>
      </div>
