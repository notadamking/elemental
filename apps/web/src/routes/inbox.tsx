...
// Local storage keys
const INBOX_VIEW_KEY = 'elemental-inbox-page-view';
const INBOX_SOURCE_FILTER_KEY = 'elemental-inbox-page-source-filter';
const INBOX_SORT_ORDER_KEY = 'elemental-inbox-page-sort-order';
...
export function InboxPage() {
  ...
  const handleNavigateToEntity = useCallback((entityId: string) => {
    navigate({
      to: '/entities',
      search: { selected: entityId, name: undefined, page: 1, limit: 25 },
    });
  }, [navigate]);
