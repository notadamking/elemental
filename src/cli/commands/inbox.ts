...
import { InboxStatus, type InboxItem, type InboxFilter } from '../../types/inbox.js';
...
export const inboxCommand: Command = {
  ...
  usage: 'el inbox <entity> [options] or el inbox <subcommand>',
