...
import type { MessageId, ChannelId } from '../types/message.js';
import {
  InboxStatus,
  InboxSourceType,
} from '../types/inbox.js';
import { NotFoundError, ConflictError, ValidationError } from '../errors/error.js';
...
describe('Inbox Schema Migration', () => {
  ...
  test('migration creates inbox_items table with correct columns', () => {
    ...
    const { initializeSchema } = require('../storage/schema.js');
    initializeSchema(db);
